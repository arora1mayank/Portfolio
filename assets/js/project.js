...
const projects = [
  {
    title: "Wallphy",
    cardImage: "assets/images/project-page/wallphy.png",
    description: "A flutter wallpaper app using pexels API and firebase authentication.",
  ...
  {
    title: "Smart Mirror",
    cardImage: "assets/images/project-page/sm.png",
    description: "A smart IoT device with raspberry pi.",
  ...
  {
    title: "Flash Chat",
    cardImage: "assets/images/project-page/flashchat.gif",
    description: "A chatting app backed by firebase using flutter.",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "",
    Githublink: "",
  },
  {
    title: "SpaceX",
    cardImage: "assets/images/project-page/quizapp.gif",
    description: "A space quiz app using flutter.",
